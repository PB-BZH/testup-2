...
module TestUp
  class TestDiscoverer
    ...
    def discover
      @errors.clear
      testsuites = {}
      @paths_to_testsuites.each do |testsuite_path|
    ...
    def discover_testcases(testsuite_path)
      ...
      testcase_source_files.each do |testcase_file|
        begin
    ...
    def all_test_classes
      ...
      ObjectSpace.each_object(Class) do |klass|
        klasses << klass if /^TC_/.match?(klass.name)
      end
      klasses
    end
    ...
    def remove_old_tests(testcase)
      if Object.constants.include?(testcase)
        ...
        MiniTest::Runnable.runnables.delete_if do |klass|

...
module TestUp
  ...
  module SketchUpTestUtilities
    ...
    def disable_read_only_flag_for_test_models
      ...
      @read_only_files = []
      Dir.glob(skp_model_filter) do |file|
  ...
  module ObserverForwarder
    ...
    def method_missing(method_sym, *arguments, &block)
      ...
      if /^on[A-Z_]/.match?(method_sym.to_s)
    ...
    def self.included(base)
      ...
      base.instance_methods.grep(/^on[A-Z_]/).each do |symbol|
  ...
  module ObserverReceiver
    ...
    module InstanceMethods
      ...
      def assert_notifications(*args)
        ...
        callback_data.each do |notification, arguments|
      ...
      def assert_notification_count(notification, expected)
        actual = if callback_data.nil? || callback_data[notification].nil?
          0
        else
          callback_data[notification].size
        end
